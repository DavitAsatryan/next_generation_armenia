...
class SignUpTeacherMobile extends StatefulWidget {
  const SignUpTeacherMobile({
    super.key,
    required this.state,
  ...
  @override
  State<SignUpTeacherMobile> createState() => _SignUpTeacherMobileState();
}

class _SignUpTeacherMobileState extends BaseState<SignUpTeacherMobile> {
