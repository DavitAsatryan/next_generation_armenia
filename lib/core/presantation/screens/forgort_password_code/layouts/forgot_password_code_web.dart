...
class ForgotPasswordCodeWeb extends StatefulWidget {
  const ForgotPasswordCodeWeb({
    super.key,
  ...
  @override
  State<ForgotPasswordCodeWeb> createState() => _ForgotPasswordCodeWebState();
}

class _ForgotPasswordCodeWebState extends BaseState<ForgotPasswordCodeWeb> {
  Timer? _debounce;
